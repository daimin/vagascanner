...
<body onpageshow='event.persisted &amp;&amp; (function(){var allInstances = CKEDITOR.instances, editor, doc;for ( var i in allInstances ){	editor = allInstances[ i ];	doc = editor.document;	if ( doc )	{		doc.$.designMode = "off";		doc.$.designMode = "on";	}}})();' topmargin="8">
  <table align="center" border="0" cellpadding="0" cellspacing="0" width="98%">
    <tbody><tr>
      ...
      <img src="images/book1.gif" height="14" width="20">&nbsp;<a href="<?php echo site_url("main/new_list")?>"><u>新闻列表</u></a> &gt;&gt; 发布新闻</td>

    </tr>
  </tbody></table>
  

<form name="form1" action="<?php echo site_url("main/new_add");?>" enctype="multipart/form-data" method="post" onsubmit="return checkSubmit()">
  ...
  <table id="needset" style="border: 1px solid rgb(207, 207, 207); background: none repeat scroll 0% 0% rgb(255, 255, 255);" align="center" border="0" cellpadding="2" cellspacing="2" width="98%">
    <tbody><tr>
      <td colspan="5" class="bline" height="24">
          ...
          <tbody><tr>
            <td width="90">&nbsp;文章标题：</td>
            <td width="408" colspan="3"><input name="title" id="title" style="width: 388px;" type="text"></td>
          </tr>
        </tbody></table></td>
    </tr>
    ...
    <tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="800">
        <tbody><tr>
          <td width="90">&nbsp;内容摘要：</td>
          <td width="449"><textarea name="resume" rows="5" id="resume" style="width: 100%; height: 50px;"></textarea></td>
          <td width="261">&nbsp;</td>
        </tr>
      </tbody></table>
      </td>
    ...
    <tr>
      ...
      <textarea id="content" name="content" style="width:90%;height:400px;visibility:hidden" ></textarea>
