...
public class Email
{
	...
	public static void main(String[] args)
	{
		...
		themail.setTo("friendxxy@163.com");//收件人地址
		themail.setFrom("friendxxy@sina.com");//发件人地址
	//	themail.addFileAffix("f:/aa.rar");// 附件文件路径,例如：C:/222.jpg,*注；"/"的写法； 如果没有可以不写
		themail.setNamePass("friendxxy@sina.com", "*******");//发件人地址和密码 **改为相应邮箱密码
		themail.sendout();
	}
}
